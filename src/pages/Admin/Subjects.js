...
import { MdOutlineAutoStories, MdPersonSearch, MdRefresh } from "react-icons/md";
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700 text-slate-400 text-xs font-bold uppercase tracking-wider">
                  {["#", "Subject Details", "Course Code", "Assigned Faculty", "Email"].map((h, i) => <th key={h} className={`px-6 py-4 ${i === 2 ? "text-center" : "text-left"}`}>{h}</th>)}
                </tr>
              </thead>
